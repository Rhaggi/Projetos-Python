...
def nomes_moedas():
    with open(r'C:\Users\RosalinaTeixeiraOliv\Documents\Cursos\Projetos Python\Conversor de moedas\moedas.xml', 'rb') as arquivo_moedas:
...
def conversoes_disponiveis():
    with open(r'C:\Users\RosalinaTeixeiraOliv\Documents\Cursos\Projetos Python\Conversor de moedas\conversoes.xml', 'rb') as arquivo_conversoes:
